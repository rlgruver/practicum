  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col s3">
        ...
        <ul>
          <li><a class="grey-text text-lighten-3" href="http://cr2g.constraintsolving.com/">CR2G Website</a></li>
          <li><a class="grey-text text-lighten-3" href="http://www.cs.utep.edu/">UTEP Computer Science</a></li>
          <li><a class="grey-text text-lighten-3" href="http://www.cs.utep.edu/mceberio/research/">Martine Ceberio</a></li>
        </ul>
      </div>
